...
namespace SistemaVenta.DAL.DBContext
{
    ...
    public partial class DbventaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C6AE66B8C");
            ...
            {
                entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2D08331F");
                ...
                entity.Property(e => e.DescripcionProdcuto)
                    .HasMaxLength(100)
                    .IsUnicode(false)
                    .HasColumnName("descripcionProdcuto");
            ...
            {
                entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4834054B4E4");
            ...
            {
                entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107C6D64855");
            ...
            {
                entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E1EF24632");
            ...
            {
                entity.HasKey(e => e.IdProducto).HasName("PK__Producto__D0AF4CB403CB1EAA");
            ...
            {
                entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76040943B5");
            ...
            {
                entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D86A122E04");
                ...
                entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                    ...
                    .HasConstraintName("FK__RolMenu__idMenu__4316F928");

                entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                    .HasForeignKey(d => d.IdRol)
                    .HasConstraintName("FK__RolMenu__idRol__4222D4EF");
            });

            modelBuilder.Entity<TipoDocumentoVenta>(entity =>
            {
                entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEEF8750EC");
            ...
            {
                entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A64D753ADE");
            ...
            {
                entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614343D9505");
